...
open_image = lambda {|name| File.read(File.expand_path(File.join __FILE__, "../../app/assets/images/soundrock/#{name}")) }
...
silvia = Artist.create(name: "Greedy Silvia And The Kinky", country: "United Kingdom", biography: lorem, homepage_url: "http://nyan.cat/")

### Artists photos ###
p = antani.photos.new
p.image = open_image["banner3.jpg"]
p.save!

p = iggy.photos.new
p.image = open_image["banner2.jpg"]
p.save!

p = silvia.photos.new
p.image = open_image["img22.jpg"]
p.save!
p = silvia.photos.new
p.image = open_image["banner4.jpg"]
p.save!
